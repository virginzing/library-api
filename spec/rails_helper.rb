...
RSpec.configure do |config|
  ...
  config.before(:example) do
    ...
    @current_user = User.create(
      full_name: @new_user_params[:full_name],
      email: @valid_email,
      address: @new_user_params[:address],
      age: 39,
      gender: @new_user_params[:gender],
      password: @valid_password
    )
    ...
    @rented_book = Book.create(
      title: 'The Lord of the Rings II',
      author: 'J. R. R. Tolkien',
      description: 'epic high-fantasy novel',
      category: Book::CATEGORIES.sample, 
      rent_by: @current_user
    )

    other_user = User.create(
      full_name: 'Liam Hemsworth',
      email: 'Liam@Hems.worth',
      address: '123 Shirley Street PIMPAMA QLD 4209 AUSTRALIA',
      age: 33,
      gender: 'Male',
      password: 'Liam Hemsworth *** 123'
    )

    @unavailiable_book = Book.create(
